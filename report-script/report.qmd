...
plt.text(2, 0.0070, "mistralai/mistral-7b-v0.1", fontsize=9, weight="bold", color="#4CAF50")
plt.text(3, 0.0123, "meta-llama/llama-2-7b-chat-hf", fontsize=9, weight="bold", color="black")
plt.text(52, 0.0035, "meta-llama/llama-3.3-70b-instruct", fontsize=9, weight="bold", color="#FFB482")
...
## Disclosure on the use of GenAI

In this project, we assure that GenAI has been used in following way and nothing more.

* Debugging and optimization: Gen-AI is a great tool for explaining error messages in understandable language. It is also suitable for optimizing non-functioning scripts that we had developed ourselves, which improves our
project efficiency.
* Information acquisition: Gen-AI is used for search of information about methodologies and code documentations, similar to how Google was used for searches. However, human verification of correctness and credibility of sources are crucial for us, because AI as a new technology that can provide inconsistent and incorrect results.
* Proofreading: Gen-AI is deployed in accelerating the proofreading process, especially in detecting grammar and typo mistakes.
* Code Documentation: Writting code documentation such as docstrings can be tedious. In such a task GenAI is of great help as, given proper instruction and model, it can understand the code and document it quite well.
