...
* Code documentation: Writing code documentation such as docstrings can be tedious. In such a task GenAI is of great help as, given proper instruction and model, it can understand the code and document it quite well.
